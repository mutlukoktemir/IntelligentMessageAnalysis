...
index = 0
# f_out = open('../output/mk_output_hybrid.tsv', 'w')
# f_out.write("Id,Category\n")
with open('../output/mk_output_hybrid.tsv', 'wt') as out_file:
    tsv_writer = csv.writer(out_file, delimiter='\t')
    tsv_writer.writerow(['Id', 'Category'])


    f_bad = open('../data/blackListTurkish.txt', 'r')
    ...
    for item in predicted_svm:
        ...
        tsv_writer.writerow([index, temp_item])
